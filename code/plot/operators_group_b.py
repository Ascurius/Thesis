...
print(f"Factor {query} in {join} secure-plain", sp)
print(f"Factor {query} in {join} secure-db", sd)
...
output_path = f"./measurements/plot/{query}_operators_{join}.png"
